      ...
      <div className="px-10 md:px-20 border-[#48515ea8] border-y text-6xl md:text-8xl flex justify-between relative"> 
        ...
        <div className='invisible hidden border-r border-[#48515ea8] w-0 md:w-2/5 md:visible px-8 md:flex justify-center flex-col items-end bg-gradient-to-br from-[#3943575d] from-1% via-[#10131a3a]  backdrop-blur-xl to-[#05060831] to-80%'>
          ...
          <div className='flex gap-4 pt-4'>
            <a href='https://open.spotify.com/track/6ljbkNIzfmFrGyYUTUAleN' target='_blank' className=' flex flex-col items-end'>
              <div className='text-base font-light'>Fort Minor</div>
              <div className='font-normal text-base text-gray-500'>Remember the Name</div>
            </a>
            <div className='w-12 rounded-full'>
              <Image src="https://i.scdn.co/image/ab67616d0000b273100fb4649eae80922bf1acbf" alt="Spotify" className='rounded-full animate-spin-slow' width={100} height={100} />
            </div>
          </div>  
        </div>
      ...
      <div className="px-10 md:pl-20 md:w-5/12 border-b border-[#48515ea8] md:order-1">
        <div className='pb-10 md:h-full pt-6 px-6 border-x border-[#48515ea8]'>
          ...
          <div className='md:flex md:flex-col md:justify-between md:h-full md:pb-8'>
            ...
            <div className='flex '>
              <Image width={500} height={500} src="/signature.png" alt="Chandra Bose" className='w-2/6 md:w-1/5 opacity-90' />
            </div>
            <div className=''>
              <div className='font-normal text-lg text-right'>FIND ME AT</div>
                <div className='flex gap-2 md:gap-4 mt-4 justify-end text-[#77818F]'>
                  <a href="https://twitter.com/Chandra_Bose31" target='_blank' className='h-14 w-14 border rounded-full md:h-8 md:w-8 md:p-5 border-[#48515ea8] flex items-center justify-center'>
                  ...
                  <a href="https://www.instagram.com/chandrabose.eth/" target='_blank' className='h-14 w-14 border rounded-full md:h-8 md:w-8 md:p-5 border-[#48515ea8] flex items-center justify-center'>
                  ...
                  <a href="https://github.com/chandrabosep" target='_blank' className='h-14 w-14 border rounded-full md:h-8 md:w-8 md:p-5 border-[#48515ea8] flex items-center justify-center'>
                  ...
                  <a href="https://www.linkedin.com/in/chandra-bose-p/" target='_blank' className='h-14 w-14 border rounded-full md:h-8 md:w-8 md:p-5 border-[#48515ea8] flex items-center justify-center'>
      ...
      <div className='border-[#48515ea8] w-full border-b flex flex-col md:flex-row justify-between '>
        <div className='px-10 border-b md:pl-20 md:pr-0 md:border-0 w-full md:w-2/4 border-[#48515ea8] h-full'>
          <div className='py-16 md:py-28 md:h-full border-x italic font-extralight text-base md:text-3xl border-[#48515ea8] text-gray-500'>
            <div className='text-center'><span className='md:text-4xl'>"</span>Keep on <span className='border-b-2 text-[#e2e2e2] border-green-500'>Building</span>, Keep on <span className='border-b-2 text-[#e2e2e2] border-green-500'>Learning,</span>
            <div className='pt-2 md:pt-4 '> and Never Stop <span className='border-b-2 text-[#e2e2e2] border-green-500'>Dreaming!</span><span className='text-lg md:text-4xl'>"</span></div></div>
          </div>
        </div>
        ...
        <div className='flex flex-col gap-6 border-x border-[#48515ea8] md:border-0 w-full md:w-fit py-20'>
          ...
          <a href='mailto:chandrabosep3112@gmail.com' className='w-full justify-center flex md:contents'>
      ...
      <div className='px-10 md:px-20 border-b  border-[#48515ea8]'>
        <div className='py-16 px-6 border-x border-[#48515ea8] text-center'>
          <div className='font-light text-base text-[#77818F]'>
            Have an interesting, stupid or crazy idea you'd like some help building? <span className='border-b text-gray-200 border-green-500'><a href="mailto:chandrabosep3112@gmail.com">Let's talk.</a></span>
          </div>

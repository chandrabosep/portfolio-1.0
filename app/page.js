  ...
  return (
    ...
    <div className='px-10 md:px-20 border-[#48515ea8]'>
      ...
      <div className="px-10 md:px-20 border-[#48515ea8] border-y text-6xl md:text-8xl flex justify-between relative"> 
        <div className='py-10 md:py-10  border-[#48515ea8] border-x px-6 relative text-white w-full font-bold'>Chandra Bose.</div>
        <div className='absolute w-full md:w-1/6 inset-x-[80%] md:top-6 md:inset-x-2/4'>
        ...
        <div className='invisible hidden border-r border-[#48515ea8] w-0 md:w-2/5 md:visible px-8 md:flex justify-center flex-col items-end bg-gradient-to-br from-[#3943575d] from-1% via-[#10131a3a]  backdrop-blur-xl to-[#05060831] to-80%'>
          ...
          <div className='flex gap-4 pt-4'>
            <div className=' flex flex-col items-end'>
              ...
              <div className='font-normal text-base text-gray-500'>Wait For You</div>
            </div>
      ...
      <div className="px-10 md:p-0  md:w-fit border-[#48515ea8] text-center text-6xl font-bold md:order-2 md:relative">
        <div className='py-10 md:py-6 border-x md:border-x-0 md:border-b border-[#48515ea8] flex'>
        <Image src="/profile.jpeg" width={800} height={800} alt="Chandra Bose" class="w-[19rem] relative h-[22rem] md:w-[25rem] md:h-[28rem] rounded-3xl ml-6 md:ml-0" />
      ...
      <div className="px-10 md:pl-20 md:w-5/12 border-b border-[#48515ea8] md:order-1">
        <div className='pb-10 md:h-full pt-6 px-6 border-x border-[#48515ea8]'>
          <div className=' text-5xl font-medium md:text-4xl'>About me</div>
          <div className='md:flex md:flex-col md:justify-between md:h-full md:pb-8'>
            ...
            <div className='pt-6'>I like <span className='text-[#e7e7e7] border-b border-green-500'>reading book's</span>, gobbling up knowledge like a <span className='text-[#e7e7e7] border-b border-green-400'>financial-literacy-loving</span> nerd!</div>
            </div>
            <div className=''>
              <div className='font-medium text-lg text-right'>FIND ME AT</div>
                <div className='flex gap-4 mt-4 justify-end text-[#77818F]'>
                  <a href="" className='h-16 w-16 border rounded-full md:h-8 md:w-8 md:p-5 border-[#48515ea8] flex items-center justify-center'>
      ...
      <div className='border-[#48515ea8] w-full border-b flex justify-between '>
        <div className='pl-10 md:pl-20 w-1/2 border-[#48515ea8] h-full'>
          <div className='py-28 md:h-full border-x italic font-extralight text-3xl border-[#48515ea8] text-gray-500'>
            <div className='text-center'>Keep on <span className='border-b-2 text-white border-green-500'>Building</span>, Keep on <span className='border-b-2 text-white border-green-500'>Learning,</span>
            <div className='pt-4 '> and Never Stop <span className='border-b-2 text-white border-green-500'>Dreaming!</span></div></div>
          </div>
        </div>
        <div className='w-1/2 bg-gradient-to-br from-[#39435727] via-[#050608] to-[#050608] text-center flex items-center justify-center'>
        <div className=' '>
